...
class GymEnv:
    ...
    def reset(self):
        ...
        #                    duration_time_ms=0)
        self.gym_env.reset(trace_path=random.choice(self.trace_set), report_interval_ms=self.step_time, duration_time_ms=0)
    ...
    def step(self, action, last_prediction, time_to_guide):
        ...
        if time_to_guide == True:
            ...
            self.gcc_estimator.update_bwe(bandwidth_prediction)
        else:
