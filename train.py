...
os.environ['CUDA_VISIBLE_DEVICES']=''  # only use CPU, don't use GPU
...
def central_agent(net_params_queues, exp_queues):
    ...
    with tf.Session() as sess, open(LOG_FILE + '_test', 'w') as test_log_file:
        ...
        while True:
            ...
            # update the central actor and critic for NUM_AGENTS times:
            ...
            epoch += 1
            avg_reward = total_reward / total_agents  # average reward of an episode(100 steps)
